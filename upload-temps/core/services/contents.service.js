...
exports.one = function (options, callback) {
    ...
    contentsModel.findOne(query)
        .select('status category title cover alias user date reading thumbnail media abstract content tags extensions')
    ...
    async.waterfall([
        ...
        function (count, callback) {
            contentsModel.find(query)
                ...
                .limit(pageSize)
                .select('status category title cover alias user date reading thumbnail abstract extensions')
                .populate('category', 'name path')
                .populate('user', 'nickname email')
                .populate('thumbnail', 'fileName description date src')
